...
class cmb_Meta_Box {
	...
	public function register_scripts() {
		...
		wp_register_script( 'cmb-datepicker', CMB_META_BOX_URL . 'assets/js/jquery.datePicker.min.js' );
		wp_register_script( 'cmb-timepicker', CMB_META_BOX_URL . 'assets/js/jquery.timePicker.min.js' );
		wp_register_script( 'cmb-scripts', CMB_META_BOX_URL .'assets/js/cmb'. $min .'.js', $scripts, self::CMB_VERSION );
