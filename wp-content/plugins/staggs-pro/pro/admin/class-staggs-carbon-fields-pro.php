 ...
 */
class Staggs_Carbon_Fields_PRO {
	...
	public function sgg_appearance_page_options() {
		...
		require_once STAGGS_BASE . '/pro/admin/fields/carbon/settings.php';
	...
	public function sgg_attribute_fields() {
		...
		require_once STAGGS_BASE . '/pro/admin/fields/carbon/attribute.php';
	...
	public function sgg_init_product_configurator_options() {
		...
		require_once STAGGS_BASE . '/pro/admin/fields/carbon/builder.php';

		require_once STAGGS_BASE . '/pro/admin/fields/carbon/theme.php';
