...
/**
 * Provide a public-facing view for the Cards step type.
 *
...
if ( $show_image ) {
	$classes .= ' cards--preview';
}
if ( isset( $sanitized_step['card_template'] ) ) {
	$classes .= ' cards-' . $sanitized_step['card_template'];
}
...
?>
<div class="option-group-options options cards option-group-options--<?php echo esc_attr( $columns ); ?><?php echo esc_attr( $classes ); ?>"
	<?php 
	if ( isset( $sanitized_step['shared_group'] ) && '' !== $sanitized_step['shared_group'] ) {
				...
				<span class="option out-of-stock">
					<span class="option-content">
						...
						<span class="option-name">
							<span class="option-label"><?php echo esc_attr( $option['name'] ); ?></span>
						</span>
						<?php 
