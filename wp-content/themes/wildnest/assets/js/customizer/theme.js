...
/**
 * Main Wildnest Scripts
 */
(function () {
    var Wildnest = function () {
        this.options = {
     ...
     */
    Wildnest.prototype.checkTouchScreen = function () {
     ...
     * @return bool
     */
    Wildnest.prototype.isMobile = function () {
        if (
     ...
     */
    Wildnest.prototype.initMenuSidebar = function () {
     ...
     * @todo Need check
     */
    Wildnest.prototype.initMobieSearchForm = function () {
    ...
    Wildnest.prototype.toggleMobileSubmenu = function (e) {
        e.preventDefault();
        var that = this;
     ...
     */
    Wildnest.prototype.toggleMobileSubmenuEvents = function (toggleIcon) {
     ...
     */
    Wildnest.prototype.initMobileSubMenu = function () {
     ...
     */
    Wildnest.prototype.slideUp = function (element, duration, callBack) {
     ...
     * @param function callBack
     */
    Wildnest.prototype.slideDown = function (element, duration, callBack) {
        if (typeof duration !== 'number') {
            duration = 0;
        }
    ...
    Wildnest.prototype.insertMenuOverlayClass = function () {
    ...
    Wildnest.prototype.setupMobileItemAnimations = function (element) {
        var h = window.height;
     ...
     */
    Wildnest.prototype.toggleClass = function (element, className) {
     ...
     * @param string className
     */
    Wildnest.prototype.addClass = function (element, className) {
        if (element instanceof NodeList) {
            for (var i = 0; i < element.length; i++) {
                element[i].classList.add(className);
            }
     ...
     * @param string className
     */
    Wildnest.prototype.removeClass = function (element, className) {
     ...
     * @param function callBack
     */
    Wildnest.prototype.addEvent = function (element, event, callBack) {
        if (element instanceof NodeList) {
            for (var i = 0; i < element.length; i++) {
     ...
     * Close menu sidebar.
     */
    Wildnest.prototype.closeMenuSidebar = function () {
     ...
     */
    Wildnest.prototype.toggleMenuSidebar = function (toggle) {
     ...
     */
    Wildnest.prototype.searchFormAutoAlign = function () {
     ...
     * Search form.
     */
    Wildnest.prototype.initSearchForm = function () {
        var searchItems = document.querySelectorAll('.header-search_icon-item');
        var that = this;
     ...
     * @return Element
     */
    Wildnest.prototype.wrapper = function (element, tag) {
     ...
     * Responsive table.
     */
    Wildnest.prototype.responsiveTable = function () {
     ...
     */
    Wildnest.prototype.responsiveVideos = function () { };

    /**
     * Inittial
     */
    Wildnest.prototype.init = function () {
        ...
        document.addEventListener(
            ...
            function (e) {
                ...
                if ('wildnest_customize_render_header' === e.detail) {
                ...
                if ('Wildnest_Builder_Item_Search_Icon__render' === e.detail) {
                    this.initMobieSearchForm();
                    this.initSearchForm();
                    this.setupMobileItemAnimations();
                }
     ...
     * @deprecated 0.2.6
     */
    function wildnest_is_mobile() {
        return Wildnest.isMobile();
    }

    window.wildnest_is_mobile = wildnest_is_mobile;
    window.Wildnest = new Wildnest();

    /**
     * Fix viewport units on Mobile.
     */
    (function () {
        if (window.Wildnest.isMobile()) {
            /**
