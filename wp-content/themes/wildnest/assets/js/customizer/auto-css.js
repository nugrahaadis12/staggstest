var WildnestAutoCSS = window.WildnestAutoCSS || null;

( function( $, api ) {
    'use strict';
    
    WildnestAutoCSS = function(){
        this.values = {};
        this.lastValues = {};
        this.devices = [ 'desktop', 'tablet', 'mobile' ];
    };
    WildnestAutoCSS._change = false;
    WildnestAutoCSS.prototype.fonts = {};
    WildnestAutoCSS.prototype.styling_fields = {
        color: null,
        image: null,
        position: null,
        cover: null,
    ...
    WildnestAutoCSS.prototype.subsets = {};
    WildnestAutoCSS.prototype.variants = {};
    WildnestAutoCSS.prototype.media_queries = {
        all: '%s',
        desktop: '%s',
    ...
    WildnestAutoCSS.prototype.box_shadow_fields = {
        color:  null,
        x:  0,
        y:  0,
        blur:  0,
    ...
    WildnestAutoCSS.prototype.reset = function(){
        this.fonts = {};
        this.subsets = {};
        this.variants = {};
        this.css = {
    ...
    WildnestAutoCSS.prototype.encodeValue =function( value ){
        return encodeURI( JSON.stringify( value ) )
    };
    WildnestAutoCSS.prototype.decodeValue = function( value ){
        return JSON.parse( decodeURI( value ) );
    };

    WildnestAutoCSS.prototype.loop_fields = function( fields, values, skip_if_val_null, no_selector ){
    ...
    WildnestAutoCSS.prototype.run = function( setting_name ){
        ...
        if ( window.Wildnest_JS ) {
            if ( window.Wildnest_JS.css_media_queries ) {
                this.media_queries = window.Wildnest_JS.css_media_queries;
            }
        }
        this.reset();

        var that = this;
        that.loop_fields( Wildnest_Preview_Config.fields );
        ...
        if ( $( '#wildnest-google-font-css' ).length <= 0 ) {
            $( 'head' ).prepend( "<link rel='stylesheet' id='wildnest-google-font-css'  href='' type='text/css' media='all' />" );
        }

        if ( url ) {
            //css_code = "\r\n@import url('"+url+"');\r\n\r\n"+css_code;
            $( '#wildnest-google-font-css' ).attr( 'href', url );
        } else {
            $( '#wildnest-google-font-css' ).remove();
        }

        css_code = css_code.trim();
        if ( $( '#wildnest-style-inline-css' ).length <= 0 ) {
            $( 'head' ).append( "<style id='wildnest-style-inline-css' type='text/css'></style>" )
        }
        $( '#wildnest-style-inline-css' ).html( css_code );
    ...
    WildnestAutoCSS.prototype.get_setting = function(name, device, key  ){
        ...
        var value;
        var df = false;
        if ( !_.isUndefined( Wildnest_Preview_Config.fields['setting|'+name ] ) ) {
            var field = Wildnest_Preview_Config.fields['setting|'+name ];
    ...
    WildnestAutoCSS.prototype.get_google_fonts_url = function(){
    ...
    WildnestAutoCSS.prototype.join = function( object, glue ){
    ...
    WildnestAutoCSS.prototype.str_value = function( value, format, value_no_unit ){
        if ( _.isEmpty( value ) ) {
            return '';
        }
    ...
    WildnestAutoCSS.prototype.setup_color = function( value, format ){
        if ( format ) {
            if ( value ) {
    ...
    WildnestAutoCSS.prototype.setup_checkbox = function( value, format ){
        if ( format ) {
            if ( value ) {
                return format;
            }
    ...
    WildnestAutoCSS.prototype.setup_image = function( value, format ){
    ...
    WildnestAutoCSS.prototype.setup_slider = function ( value, format ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    WildnestAutoCSS.prototype.setup_shadow = function ( value, format ){
        var that = this;
        if ( ! _.isObject( value ) ) {
            return '';
        }
    ...
    WildnestAutoCSS.prototype.setup_default = function( value, format ){
        if ( format ) {
            if ( value ) {
                return this.str_value( value, format );
            }
    ...
    WildnestAutoCSS.prototype.setup_css_ruler = function ( value, format ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
        value = _.defaults( value, {
    ...
    WildnestAutoCSS.prototype.setup_text_align = function( value, format ) {
        if ( format  ) {
            if ( value ) {
                return this.str_value( value, format );
            }
    ...
    WildnestAutoCSS.prototype.sanitize_color = function ( color ){
       return color;
    };

    WildnestAutoCSS.prototype.sanitize_slider = function ( value ){
        value = _.defaults( value, {
            unit: 'px',
            value: null
        });
    ...
    WildnestAutoCSS.prototype.sanitize_media = function ( value ) {
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    WildnestAutoCSS.prototype.maybe_devices_setup = function( field, call_back, values, no_selector ) {
        var code = '';
        var code_array = {};
    ...
    WildnestAutoCSS.prototype.setup_font = function ( value ){
        if( ! _.isObject( value ) ) {
            value = {};
        }
        value = _.defaults( value, {
    ...
    WildnestAutoCSS.prototype.font = function( field, values ){
        var code = '';
        var that = this;
    ...
    WildnestAutoCSS.prototype.css_ruler = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_css_ruler', value, no_selector );
    };

    WildnestAutoCSS.prototype.shadow = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_shadow', value, no_selector );
    };

    WildnestAutoCSS.prototype.slider = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_slider', value, no_selector );
    };

    WildnestAutoCSS.prototype.color = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_color', value, no_selector );
    };

    WildnestAutoCSS.prototype.checkbox = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_checkbox', value, no_selector );
    };

    WildnestAutoCSS.prototype.image = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_image', value, no_selector );
    };

    WildnestAutoCSS.prototype.text_align = function( field, value, no_selector ){
        return this.maybe_devices_setup( field, 'setup_text_align', value, no_selector );
    };

    WildnestAutoCSS.prototype.setup_styling_fields = function( fields, list, selectors, type ){
        var that  = this;
        var newfs;
        var i;
        var newList = [];
    ...
    WildnestAutoCSS.prototype.styling = function( field ){
        var that = this;
        ...
        var listNormalFields = that.setup_styling_fields( normal_fields,  Wildnest_Preview_Config.styling_config.normal_fields, selectors, 'normal' );
        var listHoverFields = that.setup_styling_fields( hover_fields,  Wildnest_Preview_Config.styling_config.hover_fields, selectors, 'hover' );

        var listTabs = _.clone( Wildnest_Preview_Config.styling_config.tabs );
        if ( tabs === false ) {
    ...
    WildnestAutoCSS.prototype.modal = function ( field ){
        var that = this;
        var values = this.get_setting( field.name, 'all' );
        if ( ! _.isObject( values ) ) {
            values = {};
    ...
    WildnestAutoCSS.prototype.setup_font_style = function ( value ){
        if ( ! _.isObject( value ) ) {
            value = {};
        }
    ...
    WildnestAutoCSS.prototype.html_replace = function( field, value ){
    ...
    WildnestAutoCSS.prototype.html_class = function( field, v ){
        var value;
        if ( _.isUndefined( v ) ) {
            value = _.clone( v );
        } else {
    ...
    WildnestAutoCSS.prototype.typography = function( field, values ){
        ...
        var fields = {};
        var devices_css = {};
        _.each( Wildnest_Preview_Config.typo_fields, function( f ){
            fields[ f.name ] = f;
        } );
    ...
    var WildnestAutoCSSInit = new WildnestAutoCSS();

    api.bind( 'preview-ready', function() {
        //WildnestAutoCSSInit.run();
        WildnestAutoCSSInit.lastValues = api.get();
        WildnestAutoCSSInit.values = api.get();
    });
