...
(function($, api) {
	...
	var header_changed = function(partial_id, remove_items) {
		...
		if (
			...
			partial_id === "wildnest_customize_render_header"
		) {
	...
	api.bind("preview-ready", function() {
		...
		function setupPreviewNamePosition() {
			$(".wildnest-grid .has_menu.builder-item-focus").each(function() {
				var parentPos = $(this)
					.closest(".wildnest-grid")
					.offset();
	...
	var skips_to_add_shortcut = {
		wildnest_customize_render_header: 1,
		wildnest_customize_render_footer: 1
	};
