...
class Wildnest_Builder_Item_Navigation_1 {
	public $id = 'navigation1';

	function item() {
		return array(
			'name'    => esc_html__( 'Navigation 1', 'wildnest' ),
			'id'      => $this->id,
			'width'   => '6',
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => esc_html__( 'Navigation 1', 'wildnest' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'wildnest' ), esc_html__( 'Navigation 1', 'wildnest' ) ),
			),

			array(
				'name'            => 'wildnest_navigation1_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'wildnest_navigation1_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
			...
			array(
				'name'       => 'wildnest_navigation1_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'wildnest_navigation1_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'wildnest_navigation1__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'wildnest_navigation1_arrow_size',
				'type'            => 'slider',
				...
				'required'        => array( 'wildnest_navigation1__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'wildnest_navigation1_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'wildnest_navigation1_item_styling',
				'type'        => 'styling',
				'section'     => $section,
			...
			array(
				'name'        => 'wildnest_navigation1_typography',
				'type'        => 'typography',
				'section'     => $section,
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Wildnest()->get_setting( 'wildnest_navigation1_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Wildnest()->get_setting( 'wildnest_navigation1__hide-arrow' ) );
		if ( $hide_arrow ) {
 ...
 * @return mixed
 */
function wildnest_change_nav_menu_item_id_navigation( $string_id, $item, $args ) {
...
add_filter( 'nav_menu_item_id', 'wildnest_change_nav_menu_item_id_navigation', 55, 3 );


// Register header item.
Wildnest_Customize_Layout_Builder()->register_item( 'header', new Wildnest_Builder_Item_Navigation_1() );
