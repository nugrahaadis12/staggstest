...
class Wildnest_Builder_Item_Navigation_Mobile {
	public $id = 'navigation_mobile';

	function item() {
		return array(
			'name'    => esc_html__( 'Mobile Navigation', 'wildnest' ),
			'id'      => $this->id,
			'width'   => '6',
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => esc_html__( 'Mobile Navigation', 'wildnest' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'wildnest' ), esc_html__( 'Mobile Navigation', 'wildnest' ) ),
			),

			array(
				'name'            => 'wildnest_navigation_mobile_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'wildnest_navigation_mobile_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
				...
				'required'   => array(
					'wildnest_navigation_mobile_style',
					'in',
			...
			array(
				'name'       => 'wildnest_navigation_mobile_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'wildnest_navigation_mobile_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'wildnest_navigation_mobile__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'wildnest_navigation_mobile_arrow_size',
				'type'            => 'slider',
				...
				'required'        => array( 'wildnest_navigation_mobile__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'wildnest_navigation_mobile_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'wildnest_navigation_mobile_item_styling',
				'type'        => 'styling',
				'section'     => $section,
			...
			array(
				'name'        => 'wildnest_navigation_mobile_typography',
				'type'        => 'typography',
				'section'     => $section,
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Wildnest()->get_setting( 'wildnest_navigation_mobile_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Wildnest()->get_setting( 'wildnest_navigation_mobile__hide-arrow' ) );
		if ( $hide_arrow ) {
 ...
 * @return mixed
 */
function wildnest_change_nav_menu_item_id_navigation_mobile( $string_id, $item, $args ) {
...
add_filter( 'nav_menu_item_id', 'wildnest_change_nav_menu_item_id_navigation_mobile', 55, 3 );


// Register header item.
Wildnest_Customize_Layout_Builder()->register_item( 'header', new Wildnest_Builder_Item_Navigation_Mobile() );
