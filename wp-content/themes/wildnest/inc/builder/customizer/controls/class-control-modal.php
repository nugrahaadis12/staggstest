<?php
class Wildnest_Customizer_Control_Modal extends Wildnest_Customizer_Control_Base {
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-wildnest-modal">';
		self::before_field();
		?>
		...
		<div class="wildnest-actions">
			...
			<a href="#" title="<?php esc_attr_e( 'Toggle edit panel', 'wildnest' ); ?>" class="action--edit" data-control="{{ field.name }}"><span class="dashicons dashicons-edit"></span></a>
		</div>
