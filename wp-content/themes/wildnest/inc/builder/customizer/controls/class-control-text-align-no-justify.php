<?php
class Wildnest_Customizer_Control_Text_Align_No_Justify extends Wildnest_Customizer_Control_Base {
	static function field_template() {

		echo '<script type="text/html" id="tmpl-field-wildnest-text_align_no_justify">';
		self::before_field();
		?>
		<#
