<?php
class Wildnest_Customizer_Control_Radio extends Wildnest_Customizer_Control_Base {
	public $disabled_msg;
	...
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-wildnest-radio">';
		self::before_field();
		?>
		<#
